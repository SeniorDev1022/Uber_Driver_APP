...
class EmailAddressPage extends StatefulWidget {
  ...
  EmailAddressPage({Key? key, required this.beforePageValue});
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle:
                          TextStyle(color: ColorManager.primary_gery_color),
                      hintText: Apptext.emailtextfilehinttext,
                      border: OutlineInputBorder(
                        borderSide: BorderSide(
                          color: ColorManager
                              .primary_gery_color, // Set the border color here
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(
                          color: ColorManager
                              .primary_gery_color, // Set the focused border color here
                          width: 2.0, // Set the border width if needed
                        ),
                      ),
                    ),
