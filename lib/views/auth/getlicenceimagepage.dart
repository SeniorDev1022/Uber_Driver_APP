...
class GetLicenceImagePage extends StatefulWidget {
  @override
  _GetLicenceImagePageState createState() => _GetLicenceImagePageState();
}

class _GetLicenceImagePageState extends State<GetLicenceImagePage> {
  XFile? _image;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'Align the Driver Licence perfectly in the \nframe to avoid rejection!',
              style: TextStyle(
                fontSize: 18,
